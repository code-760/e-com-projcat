              ...
              date.map((obj, index) => {
                return (
                  <tr>
                    ...
                    <td className=" border-b border-gray-200 bg-white text-center text-sm">
                      {obj.SubcategoryOder}
                    </td>

                    <td className=" border-b border-gray-200 bg-white text-sm">
                      {obj.Subcategorystatus ? (
                        <div className="px-2 py-2  text-center bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors">
                          Activate
                        </div>
                      ) : (
                        <div className="px-2 py-2 text-center bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors">
                          dactivate
                        </div>
                      )}
                    </td>
