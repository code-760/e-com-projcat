      ...
      <div className="container mx-auto px-4 sm:px-8">
                      <div className="py-8">
                          ...
                          <div className=' flex justify-between'>
                              <h2 className="text-2xl font-semibold leading-tight">View sub category</h2>
                              ...
                              <table className="min-w-full leading-normal">
                                  <thead>
                                      <tr>
                                          ...
                                          <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider"></th>
                                          <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Sub Category Name</th>
                                  ...
                                  <tr >
                                      ...
                                      <td className="px-5 py-5 border-b  border-gray-200 bg-white text-sm">
                                          <p className="text-gray-900 whitespace-no-wrap">Man</p>
                                      </td>
                                      <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
