              ...
              <thead>
                <tr>
                  <th className="px-10 py-3  border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                    <input type="checkbox" onChange={getallchecked}  checked={date.length == allids.length} />
                    CategroyName
                  </th>
                        ...
                        <div className="flex   items-center">
                          <div className="ml-3">
                            <p className="text-gray-900 whitespace-no-wrap">
                              <input type="checkbox"onChange={getChacdebox} value={obj._id} checked={allids.includes(obj._id)}   />
                              {obj.categoryName}
                            </p>
                          </div>
                        </div>
